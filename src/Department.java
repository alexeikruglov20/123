...
public class Department {
    ...
    public boolean remove(Equipment equipment){
        if(size==1){
            if(head.value.equals(equipment)){
    ...
    public int indexOf(Equipment equipment){
        int index = 0;
        Node buf = head;
        do{
            if(buf.value.equals(equipment)){
    ...
    public int lastIndexOf(Equipment equipment){
        int index = size-1;
        Node buf = tail;
        do{
            if(buf.value.equals(equipment)){
    ...
    @Override
    public int hashCode(){
        int hash = 31*size*name.hashCode();
        Node buf = head;
        do{
            hash^=buf.value.hash();
        }while(buf.next!=null);
